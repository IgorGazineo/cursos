...
08) Aula 20 - Template literals:
  ...
  Crie uma constante "myBook" com a palavra-chave "let" que recebe o retorno da invocação da função "getBook", passando como argumento da função um número de sua escolha entre 1 e 4 (incluindo o 1 e o 4) que representa o id de um dos objeto do array "data".
  ...
  Crie uma variável de nome "summary" que recebe o valor: "TITULO_DO_LIVRO, a NUMERO_DE_PÁGINAS-page long book, was written by AUTOR_DO_LIVRO and published in DATA_DA_PUBLICAÇÃO."
...
09) Aula 20 - Template literals:
  ...
  Faça com que a variável "summary" receba o mesmo valor da questão acima, com a diferença que a expressão que retorna o valor da "DATA_DA_PUBLICAÇÃO", retorne apenas o ano do livro.
...
12) Aula 22 - Arrow functions:
  ...
  Faça com que a variável "summary" receba o mesmo valor da questão *09*.

  Só que dessa vez, crie uma constante "getYear" que armazena uma arrow function e recebe como argumento uma string no modelo "ano-mês-dia" e retorna apenas o ano.
